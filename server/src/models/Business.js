...
const BusinessSchema = new mongoose.Schema({
  ...
  playStorePurchaseToken: { type: String },
  playStoreSubscriptionId: { type: String },
  subscriptionStatus: { type: String, enum: ['active', 'non-renewing', 'cancelled', 'inactive'], default: 'active' },
