...
- Use 'check_debtors' to see who owes money.
- Use 'check_low_stock' to see what to reorder.
- Use 'product_search' to check profit margins or prices.
- Use 'get_recent_transaction' to see the last sale.
...
Current Date: ${new Date().toDateString()}`
    ...
    if (responseMessage.tool_calls) {
        ...
        for (const toolCall of responseMessage.tool_calls) {
            ...
            // --- CRITICAL INTERCEPTION: Stop AI Loop on Special Action ---
            if (toolResult && toolResult.special_action === 'NAVIGATE') {
                return res.json({
                    ...
                    action: {
                        ...
                        params: toolResult.filter || toolResult.search
                    }
                });
            }

            // Standard Navigation Capture (Legacy/MapsApp)
