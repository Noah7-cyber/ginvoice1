...
RESPONSE STYLE: Plain text only. Do NOT use markdown bolding (like **text**) or headers (###). Use CAPITAL LETTERS for section headers and simple dashes (-) for lists. Keep it short, practical, and numbers-first.`
    };
