      ...
      <AnimatePresence>
         {showScrollTop && (
            <motion.button
               ...
               onClick={scrollToTop}
               className="fixed bottom-24 right-6 z-40 p-4 bg-slate-900 text-white rounded-full shadow-2xl hover:bg-slate-800 hover:scale-110 active:scale-95 transition-all"
